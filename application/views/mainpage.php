...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('aksicendekia/css/index.css')?>">
    <style>
        .review{
    height: 520px;
    background-image: url( <?php echo base_url('aksicendekia/asset/foto/backgroundReview.png')?>);
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 hero-kiri">
                    ...
                    <h1>
                        Aksi Nyata Cendekia Untuk <span>#SelaluBerkarya</span>
                    </h1>
                    <p>Plarform penggalangan dana untuk berbagai kreativitas mahasiswa dalam rangka untuk berkontribusi
                        untuk bangsa.</p>
                    <a href="#">
                        <button class="btn-ppdb">
                            <img src="<?php echo base_url('aksicendekia/asset/icon/arrow.svg')?>" alt="">Galang Dana
                        </button>
                    </a>
                </div>
                <div class="col-lg-5 hero-kanan mt-6">
                    <img src="<?php echo base_url('aksicendekia/asset/foto/herokanan.png')?>" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="partnership">
        <div class="container-fluid">
            <div class="header text-center">
                <h3>Digunakan Oleh 100+ Universitas</h3>
                <h1>Universitas Yang Bermitra<br>Dengan Kami</h1>
            </div>
            <!-- Slider Code -->
            <div class="slider-container">
                <div class="slider-wrapper">
                    <div class="slide">
                        <img src="<?php echo base_url('aksicendekia/asset/foto/kamuv/Frame 1184.png')?>" alt="Slide 3">
                    </div>
                    <div class="slide">
                        <img src="<?php echo base_url('aksicendekia/asset/foto/kamuv/Frame 1181.png')?>" alt="Slide 1">
                    </div>
                    <div class="slide">
                        <img src="<?php echo base_url('aksicendekia/asset/foto/itb.svg')?>" alt="Slide 2">
                    </div>
                    <div class="slide">
                        <img src="<?php echo base_url('aksicendekia/asset/foto/kamuv/Frame 1182.png')?>" alt="Slide 3">
                    </div>
                    <div class="slide">
                        <img src="<?php echo base_url('aksicendekia/asset/foto/itb.svg')?>" alt="Slide 3">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="galang">
            <h3>Bantu realisasikan mimpi para cendekia</h3>
            <h1>Kegiatan Yang Membutuhkan<br>Dana Segera</h1>
        </div>
    ...
    <div class="review">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 hero-kiri">
                    <p class="trust">Dipercaya oleh 1000+ Pengguna</p>
                    <h1>
                        Sendiri Kita Setetes<br>Bersama Kita Lautan
                    </h1>
                    <p>Menjadi jembatan perubahan dan mitra para kaum cendekia.</p>
                    <a href="#">
                        <button class="btn-ppdb">
                            <img src="<?php echo base_url('aksicendekia/asset/icon/arrow.svg')?>" alt="">Ulas Kami
                        </button>
                    </a>
                </div>
                <div class="col-lg-5 hero-kanan mt-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <p><a class="link-opacity-100" href="<?php echo site_url('AuthAdmin')?>">Tiktok</a></p>
                </div>

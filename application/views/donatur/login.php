...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('aksicendekia/css/logindonatur.css')?>">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 d-flex flex-column justify-content-center align-self-start mt-5 konten-kanan">
                <div class="d-flex flex-column justify-content-center h-100 p-5">
                    ...
                    <form method="post" action="<?php echo site_url('authdonatur/login');?>">
                    ...
                    <p class="text-center">
                        ...
                        <a href="<?php echo site_url('authdonatur/halaman_register');?>" class="fw-bold text-primary link-masuk">Daftar</a>
                    </p>
                    </form>
                </div>
            </div>
